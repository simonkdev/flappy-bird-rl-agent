...
to play Flappy Bird from a stack of grayscale frames. It uses PPO, a modified C++ Flappy Bird clone as the environment, and TensorFlow for the actor/critic networks and tf.GradientTape for gradients. 
